...
DATASET_A = {
    ...
    'venta': np.array([
        [4200, 4100, 4250, 4450, 4620, 4740, 4817, 4760],
        [5500, 5350, 5550, 5850, 6050, 6180, 6299, 6363],
        [4600, 4480, 4650, 4900, 5100, 5220, 5301, 5453],
        [3350, 3280, 3400, 3600, 3750, 3820, 3862, 3908],
        [5350, 5200, 5400, 5700, 5950, 6080, 6135, 6274],
        [2450, 2400, 2490, 2630, 2730, 2780, 2804, 2976],
        [3300, 3220, 3340, 3530, 3670, 3740, 3774, 3787],
        [4180, 4080, 4230, 4460, 4640, 4730, 4784, 4895],
        [3780, 3690, 3830, 4040, 4200, 4280, 4338, 4496],
        [5900, 5750, 5970, 6290, 6540, 6670, 6738, 6949],
    ], dtype=float),
    'alquiler': np.array([
        [22.5, 20.8, 21.5, 23.2, 24.8, 25.8, 26.4, 25.0],
        [22.8, 21.2, 22.0, 23.8, 25.2, 26.1, 26.7, 25.8],
        [20.8, 19.5, 20.2, 21.8, 23.1, 24.0, 24.4, 23.6],
        [15.6, 14.8, 15.3, 16.5, 17.5, 18.1, 18.4, 18.2],
        [18.7, 17.5, 18.1, 19.6, 20.8, 21.6, 22.0, 21.4],
        [13.4, 12.8, 13.2, 14.3, 15.1, 15.6, 15.8, 16.2],
        [15.8, 15.0, 15.5, 16.8, 17.8, 18.3, 18.6, 18.4],
        [20.0, 18.8, 19.5, 21.0, 22.3, 23.2, 23.5, 22.8],
        [17.7, 16.7, 17.3, 18.7, 19.8, 20.5, 20.8, 20.1],
        [19.8, 18.5, 19.2, 20.7, 22.0, 22.8, 23.2, 22.9],
    ], dtype=float),
}

# ---------------------------------------------------------------------------
# SET B — AYUNTAMIENTO DE BARCELONA — Venta 2012-2026, Alquiler 2000-2026
# ---------------------------------------------------------------------------
_venta_ayto_src = np.array([
    ...
    [4143, 5320, 3880, 5102, 5633, 4818, 3468, 3011, 3509, 4139],  # 2025
    [4262, 5701, 4158, 5346, 5954, 4967, 3696, 3042, 3632, 4127],  # 2026
], dtype=float)
